    ...
    <div className="glass-card p-6 flex flex-col justify-between">
      <div>
        ...
        <div className="text-xs mt-2 text-slate-400">
          {plan.plan_id != 4 ? plan.invoice_limit : 'Unlimited'} invoices • {plan.plan_id != 4 ? plan.client_limit: "Unlimied"} clients
        </div>
      ...
      <button className="mt-6 w-full bg-primary-gradient text-white py-2 rounded-lg">
        Get Started
      </button>
    </div>
  );
