...
export const FEATURES = [
  ...
  },
  {
    ...
    color: "green",
    desc: "Accept payments instantly via UPI QR",
  },
  {
    icon: "List",
    title: "Unlimited Line Items",
    color: "indigo",
    desc: "Add unlimited products or services with detailed descriptions, quantities, rates, and amounts—perfect for complex invoices",
  },
  {
    icon: "Calculator",
  ...
  },
  {
    ...
    color: "purple",
    desc: "Bill international clients in any currency",
  },
  {
    icon: "TrendingDown",
    title: "Expense Tracking",
    color: "orange",
    desc: "Track and categorize all business expenses",
  },
  {
    icon: "CheckCircle",
    title: "Payment Tracking",
    color: "green",
    desc: "Know exactly who has paid and who hasn't",
  },
  {
    icon: "Package",
    title: "Inventory Management",
    color: "blue",
    desc: "Manage stock levels and auto-update on sale",
  },

  {
    ...
    color: "purple",
    desc: "Upload your logo, set colors, and customize invoices to match your brand identity",
  },
  {
    icon: "FileBarChart",
    title: "Reports & Statements",
    color: "cyan",
    desc: "Generate detailed reports to track revenue, expenses, and profit trends",
  },
  {
    icon: "BellRing",
    title: "Auto Payment Reminders",
    color: "orange",
    desc: "Automatically send reminders to clients for faster payments and better cash flow",
  },
  {
    icon: "Send",
    title: "Estimates & Quotations",
    color: "blue",
    desc: "Create and send unlimited estimates and convert them into invoices instantly",
  },
];
...
export const ABOUT_METRICS = [
  {
    title: "Mission",
    description: "Empower every Indian business with professional tools",
  },
  {
    title: "Vision",
    description: "Make financial management effortless for 10M businesses",
  },
];
