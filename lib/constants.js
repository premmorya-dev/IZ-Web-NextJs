...
export const TEMPLATES = [
  {
    ...
    accent: "indigo",
    description:
      "A clean and professional invoice template with a balanced layout, highlighted payment summary, and clear billing sections—perfect for businesses that prefer a timeless, organized, and easy-to-read design.",
    featured: true,
    image: "standard.png",
  },
  {
    ...
    accent: "purple",
    description:
      "A clean and modern invoice template with a professional blue-accent design, organized sections, detailed itemized billing, tax breakdown, QR code, and signature area—ideal for businesses that want a polished and trustworthy look",
    image: "modern.png",
  },
...
export const ABOUT_METRICS = [
  ...
  },
  {
    title: "Vision",
    description:
      "We believe every business deserves powerful billing software without complicated accounting tools. ",
  },
];
